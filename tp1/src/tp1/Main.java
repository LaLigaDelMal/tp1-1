...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Buffer buffer = new Buffer(25, CANT_CONS); 						 //args: Cantidad de espacio en el Buffer			
		...
		Thread log_t = new Thread(log);									//creo el hilo para e log
		log_t.start();													//ejecuto el hilo
